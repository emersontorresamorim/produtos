	...
	<table width="100%">
		<thead>
			<tr>
				...
				<td  class="titulo_coluna" width="20%">Nome</td>
				<td class="titulo_coluna">Preço</td>
				<td class="titulo_coluna">Descrição</td>
				<td class="titulo_coluna">Data de Inicio da Venda</td>
				<td class="titulo_coluna">Usado?</td>
				<td class="titulo_coluna" width="20%">Remover?</td>
			</tr>
		</thead>
		<tbody>
